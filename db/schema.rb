...
ActiveRecord::Schema.define(version: 2019_03_13_071831) do
  ...
  create_table "shared_notes", force: :cascade do |t|
    ...
    t.index ["permission_id"], name: "index_shared_notes_on_permission_id"
  end
  ...
  add_foreign_key "shared_notes", "permissions"
end
